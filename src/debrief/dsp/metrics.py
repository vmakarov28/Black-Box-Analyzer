...
from debrief.dsp.events import (
    PropwashScore,
    detect_stick_snaps,
    detect_throttle_chops,
    score_propwash,
)
from debrief.dsp.filter_analysis import FilterComparison, compare_filtered_vs_unfiltered
from debrief.dsp.noise import (
    DiagonalTrace,
    HorizontalBand,
    NoiseHeatmap,
...
from debrief.dsp.step_response import StepResponseResult, compute_step_response
...
def compute_flight_metrics(flight) -> FlightMetrics:
    """flight: a debrief.parse.loader.Flight"""
    df = flight.df
