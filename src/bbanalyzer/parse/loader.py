...
from bbanalyzer.parse import setpoint as setpoint_mod
from bbanalyzer.parse.backend import run_blackbox_decode
...
def load(path: str | Path, output_dir: str | Path | None = None, keep_csv: bool = False) -> LogFile:
    ...
    if output_dir is not None:
        ...
        tmp_ctx = tempfile.TemporaryDirectory(prefix="bbanalyzer_")
